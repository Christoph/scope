...
data = json.loads(open('/home/django/graphite/static/last24h/ug_nl.json').read())
ug = json_graph.node_link_graph(data)
lsi_model = gensim.models.LsiModel.load('/home/django/graphite/static/last24h/l24h.lsi')
dicte = gensim.corpora.Dictionary.load('/home/django/graphite/static/last24h/l24h.dict')
index = gensim.similarities.MatrixSimilarity.load('/home/django/graphite/static/last24h/l24h.index')
...
with open('/home/django/graphite/static/last24h/q/q_'+ strin +'_nl.json', 'w+') as fp:
