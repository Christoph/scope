...
gensim.corpora.MmCorpus.serialize(settings.STATIC_BREV + static('last24h/l24h.mm'),corp)#/home/django/graphite/static/last24h/l24h.mm', corp)
dict.save(settings.STATIC_BREV + static('last24h/l24h.dict'))
lsi_model.save(settings.STATIC_BREV + static('last24h/l24h.lsi'))
index.save(settings.STATIC_BREV + static('last24h/l24h.index'))
