...
dict = gensim.corpora.Dictionary.load(settings.STATIC_ROOT + 'last24h/rene_data/rene.dict')
corp = gensim.corpora.MmCorpus(settings.STATIC_ROOT + 'last24h/rene_data/rene.mm')
lsi_model = gensim.models.LsiModel.load(settings.STATIC_ROOT + 'last24h/rene_data/rene.lsi')
index = gensim.similarities.MatrixSimilarity.load(settings.STATIC_ROOT + 'last24h/rene_data/rene.index')
#corpus_tfidf = gensim.corpora.MmCorpus('/tmp/corpus_tf.mm')
data = json.loads(open(settings.STATIC_ROOT + 'last24h/rene_all.json').read())
...
lsi_model.save(settings.STATIC_ROOT + 'last24h/rene_data/l24h3.lsi')
index.save(settings.STATIC_ROOT + 'last24h/rene_data/l24h3.index')
#Begin Graph visualisation
