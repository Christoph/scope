...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        sys.argv = ['curate/customers/create_nl_lsi.py', customer_key,
                    lower_step, upper_step, step_size, lower_bound, upper_bound, weight1, weight2, lsi_dim]
        exec(compile(open('curate/customers/create_nl_lsi.py').read(), 'curate/customers/create_nl_lsi.py', 'exec'))
