...
thresh = 0.08#0.1/pow(upper/210,2)  #the higher the thresh, the more critical  
ug = nx.Graph()
...
with open('data/explore/home/tgt_cluster.json', 'w+') as fp:
    json.dump(tgt,fp)
with open('data/explore/home/ug_nl_cluster.json', 'w+') as fp:
    json.dump(ug_nl,fp)
